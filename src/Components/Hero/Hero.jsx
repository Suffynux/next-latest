...
//           >
//             <span className={`inline-block px-4 py-1 sm:py-2 bg-white bg-opacity-20 ${currentSlideData.textColor} text-sm font-medium rounded-full backdrop-blur-sm border border-white border-opacity-30 mb-4`}>
...
//       {/* Slide Navigation - Aligned Left and Right */}
