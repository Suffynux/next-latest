...
const AnimatedFooter = () => {
  ...
  const services = [
    { name: 'IT Managed Services', url: '#' },
    { name: 'On-Demand Field Support (FSO)', url: '#' },
    { name: 'IT Asset Management', url: '#' },
    { name: 'Network & User Support', url: '#' },
    { name: 'Project & Change Management', url: '#' },
    { name: 'Recruitment Services (Technical & IT)', url: '#' },
    { name: 'Creative & Digital Support', url: '#' }
  ];
