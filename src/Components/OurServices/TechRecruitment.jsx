        ...
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-[#284885] opacity-90">
                Access pre-vetted IT professionals without the hiring delays.
              </p>
              <div className="pt-4">
                <Link
          ...
          <div className="pt-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                "Contract or full-time staffing across IT support, infrastructure, and cloud roles",
                "Candidate sourcing powered by specialist tech recruiters",
                "Technical interview screening, certification checks, and compliance verification",
                "Staffing for field projects, service desk, and NOC teams",
              ].map((feature, index) => (
                <div
                  key={index}
                ...
                >
                  <CheckCircle
                    className="text-[#2a4d8e] mt-1 flex-shrink-0"
                    size={22}
                  />
          ...
          <div className="grid md:grid-cols-2 gap-8 pt-8">
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl text-[#2a4d8e] font-semibold">
                  Add-on Services
                </h2>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-[#284885]">
                    Offshore and onshore recruitment support
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-[#2a4d8e] mt-1" size={18} />
                  <span className="text-[#284885]">
                    Onboarding assistance and probation management
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-[#284885] leading-relaxed">
                Rapid project staffing, coverage for absentee engineers, and
                growing IT teams.
              </p>
          ...
          <div className="relative bg-gradient-to-r from-[#2a4d8e] to-[#284885] text-white p-8 rounded-xl mt-12 overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 max-w-2xl">
                Recruiters who understand IT, local/global candidate pipelines,
                and zero time wasted on unqualified profiles.
              </p>
            </div>
          </div>
...
export default TechRecruitment;
