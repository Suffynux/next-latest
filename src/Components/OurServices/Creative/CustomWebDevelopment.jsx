...
import { CheckCircle, ArrowRight, Code, ArrowLeft } from 'lucide-react';
...
const CustomWebDevelopment = () => {
  ...
  const features = [
    "Bespoke web applications with React, Vue, or Angular",
    "Headless CMS architecture (Contentful, Strapi)",
    "Custom API development and integration",
    "Scalable backend solutions with Node.js and Python",
      ...
      <section className="bg-white text-[#284885] py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            <Code className="mx-auto h-16 w-16 text-[#2a4d8e] mb-4" />
            <h1 className="text-4xl md:text-5xl font-bold text-[#2a4d8e]">Custom Web Development</h1>
            <p className="text-lg mt-4 max-w-2xl mx-auto">
              Building high-performance, tailor-made web solutions that fit your exact business needs.
            </p>
          </div>

          <div className="bg-gray-50 p-8 md:p-12 rounded-xl border border-gray-200">
            <h2 className="text-3xl font-semibold text-[#2a4d8e] mb-8">Our Development Expertise</h2>
