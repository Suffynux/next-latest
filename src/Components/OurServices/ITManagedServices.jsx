...
const ITManagedServices = () => {
  ...
  const handleNavigation = () => {
    navigate('/contact-us'); // 👈 This navigates to /contact-us
  };
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-[#284885] opacity-90">
              A complete suite of proactive, SLA-driven managed IT solutions.
            </p>
            <div className="pt-4">
              <button
        ...
        <div className="pt-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              'Patch management, antivirus, and endpoint protection',
              'Helpdesk and service desk operations for all user tiers',
              'Managed email, backup, and business continuity support',
            ].map((feature, index) => (
              <div 
                key={index} 
        ...
        <div className="grid md:grid-cols-2 gap-8 pt-8">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-[#284885]">Cybersecurity assessments and endpoint hardening</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle className="text-[#2a4d8e] mt-1" size={18} />
                <span className="text-[#284885]">Hybrid or cloud IT operations management</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl text-[#2a4d8e] font-semibold">Ideal For</h2>
            </div>
            <p className="text-[#284885] leading-relaxed">
              SMEs, distributed teams, and companies scaling without building full IT departments.
            </p>
        ...
        <div className="relative bg-gradient-to-r from-[#2a4d8e] to-[#284885] text-white p-8 rounded-xl mt-12 overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 max-w-2xl">
              We act as your IT team — with a roadmap, reporting, and resilience built in.
            </p>
          </div>
        </div>
  ...
  // In your actual app, wrap with MainLayout:
